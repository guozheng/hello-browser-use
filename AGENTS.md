...
### 1. Top Movies Agent (`cloud/top_movies.py`)
...
- **Execution**: `uv run cloud/top_movies.py`

### 2. Top Amazon Products Agent (`cloud/top_amazon.py`)
...
- **Execution**: `uv run cloud/top_amazon.py`

### 3. Gmail Inbox Checker Agent (`cloud/gmail.py`)
